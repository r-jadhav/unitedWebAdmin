      ...
      <Form>
        <FormGroup>
          <ComponentCardV2>
            <Row>
              <Col>
                <Button color="primary" onClick={() => {editContentData();}}>Save</Button>
              </Col>
              <Col>
                <Button color="secondary" onClick={() => {editContentData();}}>Apply</Button>
              </Col>
              <Col>
            ...
            <Row>
              ...
              <Col md="3">
                <FormGroup>
                  ...
                  <Input type="text" onChange={handleInputs} defaultValue={contentDetails && contentDetails.content_type} name="content_type"/>
                </FormGroup>
              </Col>
            </Row>
          </ComponentCard>
            ...
            <Row>
              ...
              <Col md="4">
                <FormGroup>
                  ...
                  <Label>No</Label>
                  <Input name="published" value="0" type="radio" defaultChecked={contentDetails && contentDetails.published === 0 && true} onChange={handleInputs}/>
                </FormGroup>
              </Col>
              <Col md="4">
                <FormGroup>
