...
import CreationAndModification from '../../components/product/CreationAndModification';
import ProductEditButtons from '../../components/product/ProductEditButtons';
//import ProductAttachmentPart from '../../components/product/ProductAttachmentPart';
      ...
      <Form>
        <FormGroup>
          ...
          <ComponentCard
            ...
            creationModificationDate={productDetails}
                  ...
                  >
                    ...
                    {categoryLinked &&
                      categoryLinked.map((ele) => {
                        return <option key={ele.category_id} value={ele.category_id}>{ele.title}</option>;
                      })}
                  </Input>
                </FormGroup>
              </Col>
