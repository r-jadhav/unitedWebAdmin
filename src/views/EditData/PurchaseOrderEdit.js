...
const PurchaseOrderEdit = () => {
  ...
  // //getting poproduct data 
  // const getPoProductById = () => {
  //   api
  //     .post('/Purchaseorder/TabPurchaseOrderLineItem', { po_product_id: id })
  //     .then((res) => {
  //       setPoProduct(res.data.data[0]);
  //     })
  //     .catch(() => {
  //       message('Po Product Data Not Found', 'info');
  //     });
  // };
    ...
    if (selectedPoProducts) {
      selectedPoProducts.forEach((elem) => {
        ...
        api
          ...
          .then(() => {
            api
          .post('/inventory/editInventoryStock', elem).then(() => {
