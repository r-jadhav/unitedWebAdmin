...
// import CreationModification from '../../components/SubCategoryTable/CreationModification';
...
const SubCategoryEdit = () => {
  ...
  const applyChanges = () => {};
  const saveChanges = () => {
    if (subcategoryeditdetails.title !== '') {
  ...
  return (
    <>
      ...
      {/* <CreationModification subcategoryeditdetails={subcategoryeditdetails}></CreationModification> */}
    </>
  );
};
