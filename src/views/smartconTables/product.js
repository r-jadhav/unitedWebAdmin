        ...
        loading={loading}
          ...
          Button={
            <>
              ...
              <Col>
                <a
                  href="http://43.228.126.245/unitd-api/storage/excelsheets/Product.xlsx"
                  download
                >
                  <Button color="primary" className="shadow-none">
                    Sample
  ...
  <div className="row">
    <div className="panel panel-primary filterable">
      <div className="panel-heading">
        <div className="pull-right"><button className="btn btn-default btn-xs btn-filter"><span className="glyphicon glyphicon-filter"></span> Filter</button></div>
      </div>
      <table id="example" className="table display border border-secondary rounded">
              ...
              products.map((element) => {
                return (
                  <tr key={element.product_id}>
                    ...
                    <td>{element.qty_in_stock}</td>
                    <td>{element.modified_by}</td>
                    <td><Publish value={element.publisded}></Publish></td>
                  </tr>
                );
              })}
          </tbody>
